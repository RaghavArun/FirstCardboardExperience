...
namespace Unity.XR.CoreUtils
{
    ...
    public static class ReflectionUtils
    {
        ...
        {
            s_Assemblies = default;
            s_TypesPerAssembly = default;
            s_AssemblyTypeMaps = default;
        }
#endif

#if UNITY_6000_5_OR_NEWER
        static Assembly[] GetCachedAssemblies() { return s_Assemblies ?? (s_Assemblies = CurrentAssemblies.GetLoadedAssemblies().ToArray()); }
#else
