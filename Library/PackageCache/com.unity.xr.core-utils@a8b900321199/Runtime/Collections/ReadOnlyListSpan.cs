...
namespace Unity.XR.CoreUtils.Collections
{
    ...
    {
        static readonly ReadOnlyListSpan<T> s_EmptyList = new();
        ...
        /// </remarks>
        public bool Equals(ReadOnlyListSpan<T> other) => m_Enumerator.Equals(other.m_Enumerator);
        ...
        public override int GetHashCode() => m_Enumerator.GetHashCode();
        ...
        public struct Enumerator : IEnumerator<T>, IEquatable<Enumerator>
        {
            ...
            /// </summary>
            /// <returns>`true` if the next position is within the bounds of the list. Otherwise, `false`.</returns>
            ...
            {
                return HashCode.Combine(list, m_CurrentIndex, start, end);
            }
