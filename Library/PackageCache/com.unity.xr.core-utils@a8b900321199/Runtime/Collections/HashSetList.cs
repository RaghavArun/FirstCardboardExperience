...
namespace Unity.XR.CoreUtils.Collections
{
    ...
    public class HashSetList<T> : ICollection<T>, IEnumerable<T>, IEnumerable, ISerializable, IDeserializationCallback, ISet<T>, IReadOnlyCollection<T>
    {
        ...
        /// </summary>
        /// <param name="capacity">Initial capacity of the internal list and hashset.</param>
        public HashSetList(int capacity = 0) : this(capacity, null) { }

        /// <summary>
        /// Allocates internal list and hashset.
        /// </summary>
        /// <param name="comparer">The comparer implementation to use when comparing values in the hashset,
        /// or <see langword="null"/> to use the default comparer for the element type.</param>
        public HashSetList(IEqualityComparer<T> comparer) : this(0, comparer) { }
        ...
        /// <param name="comparer">The comparer implementation to use when comparing values in the hashset,
        /// or <see langword="null"/> to use the default comparer for the element type.</param>
        public HashSetList(int capacity, IEqualityComparer<T> comparer = null)
        {
            m_InternalList = new List<T>(capacity);
            m_InternalHashSet = new HashSet<T>(capacity, comparer);
        }
