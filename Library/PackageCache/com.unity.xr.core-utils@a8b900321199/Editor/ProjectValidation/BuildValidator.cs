...
namespace Unity.XR.CoreUtils.Editor
{
    ...
    public static class BuildValidator
    {
        ...
        [Obsolete("SelectObject(int) is obsolete. Use SelectObject(EntityId).", true)]
#elif UNITY_6000_3_OR_NEWER
        [Obsolete("SelectObject(int) is obsolete. Use SelectObject(EntityId).", false)]
#endif
        ...
        /// click in the issue in the validator window.
        /// </summary>
        /// <param name="entityId">The object entity id.</param>
        /// <seealso cref="BuildValidationRule.OnClick"/>
        public static void SelectObject(EntityId entityId)
        {
            var objToSelect = EditorUtility.EntityIdToObject(entityId);
            if (objToSelect != null)
                Selection.activeObject = objToSelect;
        }
#endif
